...
#     initial_prompt += (
#         "===Response Guidelines \n"
#             "1. Only generate SQL queries that perform read-only operations (e.g., SELECT). Do not generate queries that perform write operations (e.g., INSERT, UPDATE, DELETE). \n"
#             "2. Do not generate schema modification queries (e.g., ALTER TABLE, DROP TABLE, TRUNCATE TABLE). \n"
#             "3. Do not generate access control queries (e.g., GRANT, REVOKE). \n"
#             "4. Do not generate data definition queries (e.g., CREATE DATABASE, DROP DATABASE). \n"
#             "5. If the provided context is sufficient, please generate a valid SQL query without any explanations for the question. \n"
...
#    "Amount has the unit MIllion Dollors"
# ]
...
#             "8. Please use the most relevant table(s). \n"
#             "9. If the question has been asked and answered before, please repeat the answer exactly as it was given before. \n"
#             "10. If the question is ambiguous, please ask for clarification and gernerate an intermediate query. \n"
...
#     description_prompt = f"Please be concise and describe the SQL: {sql}"
...
def extract_columns_and_comparisons(sql):
    ...
    where_clause_match = re.search(r'WHERE (.*)', sql, re.IGNORECASE)
